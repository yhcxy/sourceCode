...
public class BaseContextHandler {
	...
	public static String getApp() {
		Object value = get(CommonConstants.CONTEXT_KEY_APP);
		return returnObjectValue(value);
	}
	
	public static Profile getProfile() {
		Object value = get(CommonConstants.CONTEXT_KEY_USER_PROFILE);
		return value == null ? null : (Profile)value;
	}
	...
	public static void setApp(String app) {
		set(CommonConstants.CONTEXT_KEY_APP, app);
	}
	
	public static void setProfile(Profile profile) {
		set(CommonConstants.CONTEXT_KEY_USER_PROFILE, profile);
	}
