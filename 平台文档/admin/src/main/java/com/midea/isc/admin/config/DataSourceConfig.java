package com.midea.isc.admin.config;
...
public class DataSourceConfig {
	...
	// master dao 所在的包
	public static final String PACKAGE = "com.midea.isc.admin.mapper";

	// mapper所在目录
	private static final String MAPPER_LOCATION = "classpath:mapper/admin/*.xml";
